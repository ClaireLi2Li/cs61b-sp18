...
public class TestBodyConstructor {
    ...
    private static void checkBodyConstructor() {
        System.out.println("Checking first Body constructor...");//log
        ...
        checkEquals(xxPos, b.xxPos, "xxPos"); //unit test
        ...
        Body bCopy = new Body(b); // declaration a method need declare the type the input but revoke does not
